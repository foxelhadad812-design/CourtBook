...
namespace CourtBook.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923210249_AddCommercialAndOperationalFeatures")]
    partial class AddCommercialAndOperationalFeatures
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.BookingAddon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CourtAddonId");

                    b.HasIndex("BookingId", "CourtAddonId");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.CourtAddon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.Game", b =>
                {
                    ...
                    b.HasIndex("IsPrivate", "Status");

                    b.HasIndex("CourtId", "Date", "Status");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.GameInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("InviterId", "Status");

                    b.HasIndex("GameId", "InviteeId", "Status");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.IdempotencyLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.OwnerBalance", b =>
                {
                    ...
                    b.Property<decimal>("InFlightBalance")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("OutstandingDeficit")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.ToTable("OwnerBalances");
                });

            modelBuilder.Entity("CourtBook.Domain.Entities.OwnerPayoutMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<decimal>("OwnerNetAmount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(10,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.PayoutRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("DisbursedByAdminId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DisbursedByAdminId");

                    b.HasIndex("ExternalTransactionReference")
                        .IsUnique()
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.PlayerConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.PlayerPreference", b =>
                {
                    ...
                    b.Property<string>("PreferredGameType")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.PlayerSportSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.PromoCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.PromoCodeUsage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.RecoveryObligation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ObligationReference")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<decimal>("RemainingDeficitAmount")
                        .HasColumnType("decimal(10,2)");

                    b.Property<DateTime?>("ResolvedAt")
                        .HasColumnType("datetime2");

                    b.Property<Guid?>("ResolvedBySettlementBatchId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("TotalDeficitAmount")
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.HasIndex("ObligationReference")
                        .IsUnique();
                    ...
                    b.ToTable("RecoveryObligations");
                });

            modelBuilder.Entity("CourtBook.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.SettlementBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.SettlementItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.TransactionLedger", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("CourtBook.Domain.Entities.PromoCode", "PromoCode")
                        .WithMany()
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.BookingAddon", b =>
                {
                    ...
                    b.HasOne("CourtBook.Domain.Entities.CourtAddon", "CourtAddon")
                        .WithMany()
                        .HasForeignKey("CourtAddonId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Booking");

                    b.Navigation("CourtAddon");
                });
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.GameInvitation", b =>
                {
                    ...
                    b.HasOne("CourtBook.Domain.Entities.User", "Invitee")
                        .WithMany("ReceivedInvitations")
                        .HasForeignKey("InviteeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CourtBook.Domain.Entities.User", "Inviter")
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.OwnerBalance", b =>
                {
                    b.HasOne("CourtBook.Domain.Entities.User", "Owner")
                        .WithOne("OwnerBalance")
                        .HasForeignKey("CourtBook.Domain.Entities.OwnerBalance", "OwnerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.PayoutRequest", b =>
                {
                    b.HasOne("CourtBook.Domain.Entities.User", "ApprovedByAdmin")
                        .WithMany()
                        .HasForeignKey("ApprovedByAdminId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CourtBook.Domain.Entities.User", "DisbursedByAdmin")
                        .WithMany()
                        .HasForeignKey("DisbursedByAdminId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("CourtBook.Domain.Entities.OwnerPayoutMethod", "PayoutMethod")
                        .WithMany("PayoutRequests")
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.PlayerConnection", b =>
                {
                    b.HasOne("CourtBook.Domain.Entities.User", "Addressee")
                        .WithMany("ReceivedConnections")
                        .HasForeignKey("AddresseeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CourtBook.Domain.Entities.User", "Requester")
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.RecoveryObligation", b =>
                {
                    ...
                    b.HasOne("CourtBook.Domain.Entities.User", "Owner")
                        .WithMany("RecoveryObligations")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CourtBook.Domain.Entities.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("CourtBook.Domain.Entities.RefreshToken", "ReplacedByToken")
                        .WithMany()
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.SettlementItem", b =>
                {
                    ...
                    b.HasOne("CourtBook.Domain.Entities.SettlementBatch", "SettlementBatch")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.TransactionLedger", b =>
                {
                    ...
                    b.HasOne("CourtBook.Domain.Entities.PayoutRequest", "PayoutRequest")
                        .WithMany("LedgerEntries")
            ...
            modelBuilder.Entity("CourtBook.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("RecoveryObligations");
